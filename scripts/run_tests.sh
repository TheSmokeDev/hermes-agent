...
# and Windows shell cache paths expand SYSTEMDRIVE. Dropping SYSTEMDRIVE leaves
# literal %SystemDrive% paths that can create a ProgramData tree inside the checkout.
